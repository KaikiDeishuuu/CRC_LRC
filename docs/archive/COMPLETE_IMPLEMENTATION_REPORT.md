...
3. `TELEGRAM_QUICKSTART.md` - 5 分钟快速配置 (200 行)
...
| `internal/handler/checksum_handler.go` | 集成通知 + 3 个辅助函数  | ✅ 完成           |
| `.gitignore`                           | 添加安全提示             | ✅ 完成           |
...
1. **TELEGRAM_QUICKSTART.md** - 新手友好，5 分钟上手
...
- 📖 [快速入门](./TELEGRAM_QUICKSTART.md) - 5 分钟配置
